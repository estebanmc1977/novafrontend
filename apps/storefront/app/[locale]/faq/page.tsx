...
const faqs = [
  ...
  { cat: "Pagos", q: "¿Qué métodos de pago aceptan?", a: "Tarjeta de crédito y débito (Visa, Mastercard, Amex), transferencia SPEI y efectivo en tiendas OXXO." },
  ...
  { cat: "Pagos", q: "¿Puedo pagar con OXXO?", a: "Sí, para compras únicas. Las suscripciones requieren tarjeta de crédito o débito para el cobro recurrente automático." },
