          ...
          <div className="max-w-5xl mx-auto grid lg:grid-cols-5 gap-12">
            ...
            <motion.div initial={{ opacity: 0, x: 24 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.1 }}
              ...
              <div className="bg-white rounded-2xl p-6 shadow-[0_4px_20px_rgba(13,27,53,0.05)] border border-[#005088]/6">
                <p className="text-xs font-bold text-[#9CA3AF] uppercase tracking-widest mb-4">Redes sociales</p>
                <div className="flex gap-3">
                  <a href="https://www.instagram.com/novapatch.mx?igsh=dGZ4cGNoNjluc3Vl" target="_blank" rel="noopener noreferrer"
                  ...
                  <a href="https://www.tiktok.com/@novapatch.mx?_r=1&_t=ZS-95C7N0OkUke" target="_blank" rel="noopener noreferrer"
                    className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-[#FAF7F2] hover:bg-[#EAF5FB] text-[#005088] transition-colors duration-200 text-sm font-semibold">
                    <TikTokIcon />
                    TikTok
                  </a>
